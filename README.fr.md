...
## :fr: Français | :gb: [English](https://github.com/Yobeco/MAEL_Gen/tree/main)
...
2. Introduisez le texte que vous souhaitez faire entendre dans le champ de texte (écrivez-le, ou faites `Ctrl + v` ou encore un simple `clic droit`)

3. Choisissez la langue (Menu `Langue`) dans laquelle est votre texte.

4. Choisissez le mode (Menu `Paramètre`) selon votre objectif.

5. Ajustez la taille du code QR (champ `Taille` ou glissière)

6. Collez dans votre document :  LibreOffice Writer <img src="https://cdn.simpleicons.org/libreofficewriter/808080" width="24" height="24" style="vertical-align: middle;" />, Draw <img src="https://cdn.simpleicons.org/libreofficedraw/808080" width="24" height="24" style="vertical-align: middle;" />ou n'importe-quel autre éditeur...
...
2. **Partagez** le dossier où se trouve le fichier .mp3 **avec toutes les personnes possédant le lien**.

3. Récupérer le lien de partage.

4. Coller ce lien dans MAEL Gen.

5. Ajustez la taille (champ `Taille`ou glissière).
